<div class="modal fade" id="quote_modal" style="top:30% !important" tabindex="-1" role="dialog"
     aria-labelledby="quote_modal" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="classContent">
                <form name="quoteAdd" id="quoteAdd" action="admin.php?action=add_quote" method="post">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-form display-4" id="rr_modal_quote">Add Quote
                </button>
            </div>
        </div>
    </div>
